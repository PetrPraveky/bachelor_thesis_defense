...
\begin{column}{0.35\textwidth}
	...
	\item Increased need for high-fidelity virtual environments for simulation, testing and training.
	\item Creating realistic virtual environments manually is challenging and time consuming process.
	\end{itemize}
\end{column}
...
\begin{column}{0.45\textwidth}
	\begin{itemize}
		\item Introduce a method of autonomous environment generation.
		\item Implement the pipeline as Unreal Engine~5 plugin.
		\item Generate environments using the proposed method.
		\item Create datasets from the generated environments using Flight Forge simulator.
...
\begin{column}{0.45\textwidth}
	\begin{block}{Skeletonization}
		\begin{itemize}
			\item Jain--Kumar algorithm
			\item Creates 1-px wide skeleton from binary mask.
			\item Can cause undesired branching if the binary mask is not smooth.
			\item Polyline used for spline interpolation is easy to create from 1-px wide skeleton.
		\end{itemize}
	\end{block}	
	
	\begin{block}{Mask Smoothing}
		\begin{itemize}
			\item Smoothing is done by utilizing Gaussian blur.
			\item Can reduce branching of the skeletonization while maintaining the general shape of the skeleton.
		\end{itemize}
	\end{block}	
\end{column}
...
\begin{column}{0.45\textwidth}
	\begin{figure}[h]
		...
		\caption{Skeletonization without smoothing}
	\end{figure}
	
	\begin{figure}[h]
		\centering%
		\includegraphics[keepaspectratio,height=2.5cm]{fig/screenshots/image_skel_2.png}%
		\caption{Skeletonization with smoothing}
	\end{figure}
\end{column}
...
\begin{column}{0.45\textwidth}
	\begin{block}{Biome Map}
		\begin{itemize}
			\item Segmentation can be used as biome map.
			\item Faster biome generation.
			\item Can not be easily manually adjusted.
		\end{itemize}
	\end{block}
...
\begin{column}{0.45\textwidth}
	\begin{block}{Biome Spline}
		\begin{itemize}
			\item Can be easily adjusted.
			\item Creation is more time consuming.
		\end{itemize}
	\end{block}
	
	\begin{figure}[h]
		\centering%
		\includegraphics[keepaspectratio,height=6cm]{fig/screenshots/biome_spline.png}
	\end{figure}
\end{column}
